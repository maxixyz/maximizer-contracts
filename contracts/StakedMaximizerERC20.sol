...
contract StakedMaximizerERC20 is ERC20Permit, Ownable {
    ...
    constructor() ERC20("Staked Maximizer", "sMAXI", 9) ERC20Permit() {
    ...
    /**
        @notice increases sMAXI supply to increase staking balances relative to profit_
    ...
    // Staking contract holds excess sMAXI
